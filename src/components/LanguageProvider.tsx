...
const MESSAGES: Record<Language, Translations> = {
  en: {
    ...
    home_employer_eyebrow: "I am an employer",
    home_employer_h: "Hire workers in 48 hours.",
    home_employer_cta: "Speak to a consultant →",
    home_worker_eyebrow: "I am a worker",
    home_worker_h: "Apply for a job in Singapore.",
    home_worker_cta: "Submit your application →",
    home_how_h: "How it works.",
    home_ind_h: "Seven sectors, one bench.",
    home_trust_eyebrow: "Why employers stay",
    home_team_eyebrow: "Our consultants",
    home_team_h: "All ten, all registered.",
    home_faq_h: "Things people ask before they sign.",
    home_closing_h: "One message away from a fully-staffed week.",
  ...
  zh: {
    ...
    home_employer_eyebrow: "我是雇主",
    home_employer_h: "48小时内招聘工人。",
    home_employer_cta: "联系顾问 →",
    home_worker_eyebrow: "我是求职者",
    home_worker_h: "在新加坡申请工作。",
    home_worker_cta: "提交申请 →",
    home_how_h: "如何运作。",
    home_ind_h: "七个行业，一支团队。",
    home_trust_eyebrow: "为什么雇主选择我们",
    home_team_eyebrow: "我们的顾问",
    home_team_h: "十位顾问，全部注册。",
    home_faq_h: "签约前常见问题。",
    home_closing_h: "一条消息，招齐全周人手。",
